...
namespace Robust.Server.HotReload.Reflection;

/// <summary>
/// Represents a reader that can parse the byte stream of a method body,
/// reading its IL opcodes and operands.
/// </summary>
/// Adapted from https://github.com/Kir-Antipov/HotAvalonia/blob/master/src/HotAvalonia/Reflection/MethodBodyReader.cs
internal struct MethodBodyReader
{
    ...
    private readonly void EnsureOperandSize(int size)
    {
        ...
        ThrowInvalidOperationExceptionSizeDoesNotMatch(size, _opCode.GetOperandSize());

        static void ThrowInvalidOperationExceptionSizeDoesNotMatch(int expectedSize, int actualSize)
